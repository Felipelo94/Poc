...
import InternalCorporativoAccionista from './internal-corporativo-accionista'
...
const initialState = {
  ...
  accesibility: { fontSize: 3, lineSize: 2 }
}

describe('Test for InternalCorporativoAccionista template', () => {
  beforeAll(() => {
