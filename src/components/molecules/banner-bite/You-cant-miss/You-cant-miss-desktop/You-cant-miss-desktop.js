...
export default function YouCantMissDesktop({
  index,
  data,
  numBite,
  idCarrusel,
  ...
  useEffect(() => {
    setprevCarrusel(
      indexSlider <= indexBitestate && indexSlider !== 0 && indexBitestate > 1
    )
  }, [indexSlider, indexBitestate])

  useEffect(() => {
    const limitBite = width >= 1920 ? (width >= 2560 ? 2 : 3) : 4
    const limitBiteDinamic = width >= 1920 ? (width >= 2560 ? 4 : 3) : 2
    const validationShow =
      indexSlider < data.length - limitBiteDinamic && indexSlider < limitBite
                ...
                >
                  ...
                  >
                    ...
                    <BiteDesktop
                      ...
                      imgTitle={items.imagenpequena?.title}
                      slug={items.urlSeo}
