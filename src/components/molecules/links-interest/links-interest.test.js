...
import LinksInterest from './links-interest'
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              ...
              data: { uri: 'https://www.proteccion.com/rutadeaprendizaje/' }
            },
            {
              nodeType: 'text',
              value: '',
                  ...
                  'en-US': [
                    {
                      ...
                      fields: {
                        ...
                        description: { 'en-US': 'Logotipo de EmpleoYa' },
                        file: {
                          'en-US': {
                            url:
          ...
          data: {
            target: {
              ...
              fields: {
                ...
                descripcion: { 'en-US': 'Trabajo hecho a tu medida' },
                textoCallToAction: { 'en-US': 'Hazlo ahora' },
                linkCallToAction: {
                  'en-US':
                  ...
                  'en-US': [
                    {
                      ...
                      fields: {
                        title: { 'en-US': 'Travail' },
                        description: { 'en-US': 'Logotipo Travail' },
                        file: {
                          'en-US': {
                            url:
          ...
          data: {
            target: {
              ...
              fields: {
                ...
                descripcion: { 'en-US': 'Tenemos trabajos para estudiantes.' },
                textoCallToAction: { 'en-US': 'Hazlo ahora' },
                linkCallToAction: {
                  'en-US':
      ...
      content: [
        {
          nodeType: 'heading-2',
          content: [
            { nodeType: 'text', value: 'Herramientas:', marks: [], data: {} }
          ],
          data: {}
        },
        {
        ...
        },
        {
          ...
          data: {
            target: {
              ...
              fields: {
                tituloCorto: {
                  'en-US': 'Herramientas para tu vida laboral y emprendimientos'
                },
                textoIntroductorio: {
                  'en-US':
              ...
              fields: {
                ...
                imagenpequena: {
                  'en-US': {
                    ...
                    fields: {
                      title: {
                        'en-US': 'Imagen consejos para tu vida laboral'
                      },
                      description: {
                        'en-US':
          ...
          data: {
            target: {
              ...
              fields: {
                ...
                TextoCallToAction: { 'en-US': 'Hazlo ahora' },
                LinkCallToAction: { 'en-US': 'https://fondosumanti.com/' }
              }
            }
          },
          content: [],
...
describe('Button', () => {
  it('renders correctly without props', () => {
    const tree = renderer.create(<LinksInterest />).toJSON()
    expect(tree).toMatchSnapshot()
  })

  it('ModalButton close modal mobile', () => {
    const wrapper = mount(<LinksInterest />)
  })
})
