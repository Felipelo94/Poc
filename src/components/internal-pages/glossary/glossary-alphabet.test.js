...
import GlossaryAlphabet from './glossary-alphabet'

describe('Test for GlossaryAlphabet component', () => {
  test('should render correctly without props', () => {
    const wrapper = shallow(<GlossaryAlphabet />)
    expect(wrapper.hasClass('glossary-alphabet-container')).toBeTruthy()
  })
