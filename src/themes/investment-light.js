...
import MoreIconoVerde from '../../src/assets/images/boton-yellow.svg'
import CerrarPerfilamientoMobile from '../../src/assets/images/Cerrar-sesion-mobile-negro.svg'
import VerTutorialMobile from '../../src/assets/images/eye-ver-tutorial-mobile-negro.svg'
import PQRSMobile from '../../src/assets/images/file-pqrs-ver-tutorial-mobile-negro.svg'
...
import XCerrarSubmenuMobile from '../../src/assets/images/icons/x-icon-menu-gris.svg'

export default {
  name: 'investment-light',
  ...
  colors: {
    ...
    menuDesktop: {
      ...
      bgIconMoreActive: `url(${MoreIconoVerde})`,
      colorNoTouchPeperoni: '#626277',
      colorHoverPeperoniTitle: '#626277',
      colorHoverPeperoniIcon: '#292730',
      colorHoverAnotherPeperoni: '#B4BCCE'
    },
    menuMobile: {
      opcionesTitleH4: '#292730',
      colorBorderButtonClose: '#292730',
      colorButtonClose: '#292730',
      colorOpcionesTitle: '#292730',
    ...
    menuAccessibility: {
      ...
      colorLabelUserTypeInactive: '#CBD1DE',
      colorIconUserTypeActive: '#464454',
      colorIconUserTypeInactive: '#CBD1DE',
      colorIconAccessibilityActive: '#292730',
      colorIconAccessibilityInactive: '#0033A0',
      colorLabelAccessibility: '#CBD1DE',
      colorLabelAccessibilityItem: '#FFFFFF',
      colorLabelAccessibilityItemDesktop: '#292730',
      colorIconAccessibilityItemDesktop: '#292730',
      colorBorderBottomAccessibilityItem: '#464454',
      backgroundContainerMobile: '#292730',
      colorIconsAccessibilityItem: '#FFFFFF',
      colorSwitchAccessibilityItem: '#292730',
      colorCheckedSwitchAccessibilityItem: '#292730',
      bgColorTrackAccessibilityItem: '#FFFFFF',
      borderColorTrackAccessibilityItem: '#292730',
      bgColorCheckedTrackAccessibilityItem: '#E3E829',
      borderColorCheckedTrackAccessibilityItem: '#E3E829'
    },
    opciones: {
      colorOpcionesBackground: '#292730',
      colorOpcionesTitulo: '#FFFFFF',
      colorOpcionesParaph: '#CBD1DE',
      colorOpcionesParaphHover: '#FFFFFF',
      colorBordeHrMenu: '#464454',
      colorOpcionesIconosActive: '#0033A0',
      colorOpcionesIconosInactive: '#CBD1DE',
      opcionesIconoBackground: `url(${ActiveTutorialGreen})`,
      colorSeparator: '#464454'
    },
    categorias: {
      colorCategoriaBackground: '#292730',
      colorCategoriaNameTitulo: '#FFFFFF',
      colorCategoriaLink: '#5CD9E3',
      colorCategoriaActive: '#FFFFFF',
      colorCategoriaInactive: '#CBD1DE',
